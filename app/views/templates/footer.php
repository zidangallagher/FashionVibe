    ...
    <footer class="bg-gray-900 text-white mt-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    <h3 class="text-2xl font-bold mb-4">FashionVibe</h3>
                    <p class="text-gray-400">Temukan gaya fashion terbaikmu bersama kami. Kualitas terjamin dengan harga terbaik.</p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="/shipping" class="text-gray-400 hover:text-white transition-colors">Pengiriman</a></li>
                        <li><a href="/returns" class="text-gray-400 hover:text-white transition-colors">Pengembalian</a></li>
            ...
            <div class="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
                <p>&copy; <?= date('Y') ?> FashionVibe. All rights reserved.</p>
            </div>
        </div>
    </footer>
